  ...
  return (
    <div className={`rounded-xl overflow-hidden shadow-[rgba(7,_65,_210,_0.1)_0px_9px_30px] ${className}`}>
        ...
        <div className='p-5'>
            ...
            <p className='text-dark-light text-sm md:text-lg mt-3'>
                Majority of peole will work in jobs that don’t exist today.
            </p>
            <div className='flex justify-between flex-nowrap items-center mt-6 md:gap-x-2.5'>
                <div className='flex items-center gap-x-2'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <div className='flex items-center gap-x-2'>
                            ...
                            <span className='italic text-dark-light text-xs md:text-sm'>Verified Water</span>
                        </div>
                    </div>
